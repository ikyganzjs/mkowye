...
// Linkedin
app.get("/linkedin/login", (req,res)=> linkedin.login(req,res));
app.get("/linkedin/callback", (req,res)=> linkedin.callback(req,res));
app.get("/linkedin/get-token", (req,res)=> linkedin.getAccessToken(req,res));
app.get("/linkedin/search-job", (req,res)=> linkedin.searchJobEndpoint(req,res));
